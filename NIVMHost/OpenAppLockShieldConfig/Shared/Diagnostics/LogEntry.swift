...
nonisolated enum LogSource: String, Sendable {
    ...
    static func current(bundleIdentifier: String?) -> LogSource {
        ...
        case "dev.bchen.Quietform.Monitor": return .monitor
        case "com.tianya.appbox.shieldconfig": return .shieldConfig
        case "com.tianya.appbox.shieldaction": return .shieldAction
        case "com.tianya.appbox.report": return .report
        default: return .app
        }
    }
}
